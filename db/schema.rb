...
ActiveRecord::Schema.define(:version => 20140314204124) do
  ...
  create_table "custom_fields_insert_roles", :force => true do |t|
  ...
  create_table "custom_fields_statuses", :force => true do |t|
    t.integer "issue_status_id",                :null => false
    t.integer "custom_field_id",                :null => false
    t.integer "is_required",     :default => 0
  ...
  create_table "custom_fields_update_roles", :force => true do |t|
    t.integer "custom_field_id", :default => 0, :null => false
    t.integer "role_id",         :default => 0, :null => false
  end
  ...
  create_table "issue_favicon_user_settings", :force => true do |t|
    t.integer  "user_id"
    t.boolean  "enabled"
    t.datetime "created_on"
    t.datetime "updated_on"
  ...
  add_index "issue_favicon_user_settings", ["user_id"], :name => "index_issue_favicon_user_settings_on_user_id"
  ...
  create_table "issue_statuses", :force => true do |t|
    ...
    t.boolean "is_watcher_required"
    t.boolean "is_required_status_change"
    t.boolean "is_required_nota_publica_obligatoria"
  end
  ...
  create_table "issues", :force => true do |t|
    ...
    t.decimal  "estimated_hours",            :precision => 11, :scale => 2
    t.integer  "parent_id"
    t.integer  "root_id"
    t.integer  "lft"
    t.integer  "rgt"
    t.boolean  "is_private",                                                :default => false, :null => false
    t.boolean  "has_first_answer_date"
    t.boolean  "has_solution_date"
    t.boolean  "has_temporal_solution_date"
    t.integer  "route_id"
    t.boolean  "is_from_redmine"
  ...
  create_table "projects", :force => true do |t|
    ...
    t.boolean  "is_watcher_required"
    t.boolean  "is_public_required"
    t.boolean  "is_client_automatic_routing"
    t.boolean  "asignado_a_obligatorio"
    t.boolean  "nota_publica_obligatoria_estado_cliente"
    t.boolean  "activar_clear_quest"
    t.boolean  "first_answer_for_bank"
  ...
  create_table "time_entries", :force => true do |t|
    ...
    t.integer  "user_id",                                    :null => false
    t.integer  "issue_id"
    t.decimal  "hours",       :precision => 11, :scale => 2, :null => false
    t.string   "comments"
  ...
  create_table "validacion_cqs", :force => true do |t|
    t.string   "campo_id"
    t.string   "nombre"
    t.string   "parent_cq_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "project_id"
  end
