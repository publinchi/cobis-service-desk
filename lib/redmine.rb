...
Redmine::AccessControl.map do |map|
  ...
  map.project_module :issue_tracking do |map|
    ...
    map.permission :view_issues, {:issues => [:index, :show],
      ...
      :read => true
    map.permission :add_issues, {:issues => [:new, :create, :update_form, :get_assignable_users], :attachments => :upload}
    map.permission :edit_issues, {:issues => [:edit, :update, :bulk_edit, :bulk_update, :update_form, :update_assigned_to, :get_assignable_users], :journals => [:new], :attachments => :upload}
    map.permission :manage_issue_relations, {:issue_relations => [:index, :show, :create, :destroy]}
    map.permission :manage_subtasks, {}
    map.permission :set_issues_private, {}
    map.permission :set_own_issues_private, {}, :require => :loggedin
    map.permission :add_issue_notes, {:issues => [:edit, :update, :update_form, :get_assignable_users], :journals => [:new], :attachments => :upload}
    ...
    map.permission :delete_own_attached_files, {}
    map.permission :delete_attached_files, {}
    # Queries
    ...
    map.permission :priority, {}
    map.permission :assigned_to, {}
    map.permission :category, {}
    map.permission :start_date, {}
    map.permission :due_date, {}
    map.permission :estimated_hours, {}
    map.permission :done_ratio, {}
    map.permission :edit_closed_issues, {}
    map.permission :add_issue_notes_to_closed_issues, {}
    map.permission :export_statuses, {}
    map.permission :edit_status, {}
    map.permission :edit_priority, {}
    map.permission :edit_assigned_to, {}
    map.permission :edit_category, {}
    map.permission :edit_start_date, {}
    map.permission :edit_due_date, {}
    map.permission :edit_estimated_hours, {}
    map.permission :edit_done_ratio, {}
    map.permission :client_automatic_routing, {}
    map.permission :view_entries_without_answer, {}
    map.permission :view_responsable, {}    
    #Actualizacion sin cambio de fecha
    map.permission :edit_issues_update, {:issues => [:edit, :update, :edit_extra, :update_extra, :bulk_edit, :bulk_update, :update_form, :get_assignable_users], :journals => [:new]}
