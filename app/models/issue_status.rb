...
class IssueStatus < ActiveRecord::Base
  ...
  def self.find_by_id_custom(ids)
    ActiveRecord::Base.connection.select_all("select cf.id as id,cf.name as name,cfs.is_required as obligatorio from custom_fields cf join custom_fields_statuses cfs on cf.id=cfs.custom_field_id where cfs.issue_status_id=#{ids}")
  end
