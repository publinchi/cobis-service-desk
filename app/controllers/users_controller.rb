...
class UsersController < ApplicationController
  ...
  def create
    ...
    @user.client = params[:user][:client]
    @user.edit_avatar = params[:user][:edit_avatar]
  ...
  def update
    ...
    @user.pref.attributes = params[:pref]
    @user.client = params[:user][:client] if !params[:user][:client].blank?
    @user.edit_avatar = params[:user][:edit_avatar] if !params[:user][:edit_avatar].blank?
